...
parser.add_argument('--name', required=False, default='oasis_color_v15',  help='project name')
...
parser.add_argument('--train_epoch', type=int, default=33)
...
# Mr2RGB Generator
A2BG = net.generator_seg_attention(args.in_ngc, args.out_ngc, args.ngf)
